...
let grid1=document.querySelector(".grid5")
...
let elements = document.querySelectorAll(".grid5"); 
document.documentElement.style.margin = 'auto';//

document.body.style.backgroundColor=`rgb(208, 240, 192)`//
button.style.backgroundColor = "rgb(208, 240, 192)";
...
button.onclick = function () {
  ...
  if (button.classList.contains("container2")) {
   ...
   button.style.backgroundImage = 'url("../image/realistic-luxury-background_23-2149354606.avif")';
    // document.body.style.backgroundColor = "#16263D";
   // document.body.style.backgroundImage=``//
   document.body.style.backgroundImage = 'url("../image/realistic-luxury-background_23-2149354606.avif")';
   ...
   elements.forEach((element) => {
    ...
    element.style.color=`rgb(255, 137, 51) `
    let loading=document.getElementsByTagName("caption")
    for(let i=0; i<loading.length; i++){
      loading[i].style.color=`rgb(255, 137, 51)`
    }
   
    let loading2=document.getElementsByTagName("h1")

    for(let i=0; i<loading.length; i++){
      loading2[i].style.color=` rgb(255, 137, 51) `
    }
