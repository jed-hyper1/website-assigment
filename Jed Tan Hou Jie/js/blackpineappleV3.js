...
let grid1=document.querySelector(".grid3")
...
let elements = document.querySelectorAll(".grid3"); 
document.documentElement.style.margin = 'auto';//
document.body.style.backgroundColor=`rgb(241,235,156)`//
button.style.backgroundColor = "rgb(241,235,156)";
...
button.onclick = function () {
  ...
  if (button.classList.contains("container2")) {
    ...
    button.style.backgroundImage = 'url("../image/luxury-dark-polygonal-background_52683-26545.avif")';
    // document.body.style.backgroundColor = "#16263D";
   // document.body.style.backgroundImage=``//
   document.body.style.backgroundImage = 'url("../image/luxury-dark-polygonal-background_52683-26545.avif")';
   ...
   elements.forEach((element) => {
    ...
    element.style.color=`rgb(86, 204, 242) `
    let loading=document.getElementsByTagName("caption")
    for(let i=0; i<loading.length; i++){
      loading[i].style.color=`rgb(86, 204, 242)`
    }
   
    let loading2=document.getElementsByTagName("h1")

    for(let i=0; i<loading.length; i++){
      loading2[i].style.color=`rgb(86, 204, 242)`
    }
   ...
   //document.body.style.backgroundImage = 'url("../phone/th (4).jpeg")';//
...
document.body.style.backgroundColor = "rgb(241, 235, 156)";
    ...
    elements.forEach((element) => {
      ...
      // element.style.backgroundColor=`rgb(241, 235, 156)`//
